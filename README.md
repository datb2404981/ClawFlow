<div align="center">
  ...
  <br />
  <img src="docs/screenshots/chat_welcome.png" alt="ClawFlow Chat Interface" width="800" style="border-radius: 10px; border: 1px solid #e2e8f0;" />
</div>
...
<div align="center">
  <img src="docs/screenshots/agent_config.png" alt="Agent Configuration" width="800" style="border-radius: 10px; border: 1px solid #e2e8f0; margin-bottom: 20px;" />
  <p><i>Giao diện cấu hình Agent với System Prompt và Kỹ năng tùy chỉnh</i></p>
</div>
...
### 1. Kết nối ứng dụng (Integrations)
Hỗ trợ kết nối Google (Gmail, Calendar, Drive) và Notion thông qua OAuth2.
![Integrations](docs/screenshots/integration_settings.png)

### 2. Phê duyệt hành động (Human-in-the-loop)
AI sẽ hỏi ý kiến người dùng thông qua các thẻ hành động trực quan trước khi thực hiện các thao tác quan trọng.
![Gmail Approval](docs/screenshots/gmail_approval.png)

### 3. Soạn thảo Email thông minh
Giao diện soạn thảo email với tính năng tối ưu hóa nội dung bằng AI.
![Email Draft](docs/screenshots/email_draft_modal.png)
